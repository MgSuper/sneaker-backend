...
module.exports = {
    createUser: async (req, res) => {
        ...
        try {
            await newUser.save();
            res.status(201).json({ message: "User successful created!" }); // 201 signifies a succesful creation of something
    ...
    loginUser: async (req, res) => {
        try {
            ...
            // a spread opeartor and exclude the password and send everything in res
            // ...others means create other variable (new value)
